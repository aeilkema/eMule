...
public:
	...
	INT_PTR GetStandardListSize() const							{ return m_StandardOrder_list.GetCount(); }
	...
	HANDLE GetSocketAvailableEvent() const						{ return m_eventSocketAvailable; }
...
private:
	...
	CArray<ThrottledFileSocket*> m_StandardOrder_list; // sockets that have upload slots. Ordered so the most prioritized socket is first
