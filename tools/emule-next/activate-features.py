...
for script_name in (
    ...
    "activate-search2-product-hardening.py",
    "activate-search2-compile-fixes.py",
    "activate-search2-saved-codec-hardening.py",
    ...
    "activate-library2-compile-hardening.py",
    ...
    "activate-ui-navigation-modernization2-dashboard.py",
    "activate-database-recovery-diagnostics2.py",
    ...
    "verify-search2-product-hardening.py",
    "verify-search2-compile-contracts.py",
    "verify-search2-saved-codec.py",
