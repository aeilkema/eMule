...
def main() -> int:
    ...
    for marker, label in (
        ...
        ("std::vector<size_t> SelectedIndices", "bounded multi-selection helper"),
    ...
    for marker, label in (
        ...
        ("SelectedIndices(size_t limit = 2000)", "bounded bulk selection declaration"),
        ("selected.size() < limit", "bounded bulk selection implementation"),
