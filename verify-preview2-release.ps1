...
$requiredFiles = @(
    ...
    "tools\emule-next\activate-preview2-warning-cleanup-shareddirs.py",
    "tools\emule-next\activate-preview2-warning-cleanup-search2.py",
    "tools\emule-next\activate-preview2-warning-cleanup-legacy.py",
    "tools\emule-next\activate-preview2-warning-cleanup-cwnd.py",
